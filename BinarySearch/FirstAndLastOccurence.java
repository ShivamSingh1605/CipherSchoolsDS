...
public class FirstAndLastOccurence {
	...
	public int LastOcuurence(int arr[],int x)
	{
		int start =0;
		int end =arr.length-1;
		int res=-1;
	...
	public static void main(String[] args) {
		...
		int LastElementOcuurence=sc.nextInt();
		
		 LastElementOcuurence=obj.LastOcuurence( arr, ElementToSearch );
		System.out.println(ElementPresentAt);
		System.out.println(LastElementOcuurence);
